...
import {
  Box, Card, CardContent, Typography, MenuItem, Select,
...
function useAuditLogs(page, pageSize) {
  return useQuery({
    queryKey: ['tenant', 'audit', page, pageSize],
    queryFn: () =>
...
export default function TenantAuditPage() {
  ...
  const { data, isLoading } = useAuditLogs(paginationModel.page, paginationModel.pageSize)
  ...
  return (
    <Box>
      <PageHeader
        title="Audit Logs"
        subtitle="Security events for your organization"
      />
