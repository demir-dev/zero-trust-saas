...
import { cardContainerVariants, cardVariants, pageVariants } from '../../../shared/utils/motionVariants'
...
export default function DevicesPage() {
  ...
  if (isLoading) {
    return (
      <Box>
        <PageHeader title="Devices" subtitle="Trusted device management" />
  ...
  return (
    <motion.div variants={pageVariants} initial="initial" animate="animate">
      <PageHeader title="Devices" subtitle="Manage trusted devices for your account" />
              ...
              <Grid item xs={12} sm={6} md={4} key={d.id}>
                <motion.div variants={cardVariants}>
                  <Card sx={{
                    height: '100%',
                    border: '1px solid',
                    borderColor: d.status === 'Trusted' ? 'rgba(34,197,94,0.2)' : d.status === 'Blocked' ? 'rgba(239,68,68,0.2)' : 'divider',
                    ...
                    <CardContent sx={{ p: 2.5 }}>
                      ...
                      <Stack spacing={0.5} sx={{ mb: 2 }}>
                        ...
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                          ...
                          <Typography variant="caption" sx={{ color: 'text.secondary' }}>{d.country}</Typography>
                        </Box>
                      </Stack>
